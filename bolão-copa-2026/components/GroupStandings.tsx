...
export const GroupStandings: React.FC<GroupStandingsProps> = ({ matches, currentUser }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20">
      ...
      {/* Introduction Card */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-500 dark:from-blue-700 dark:to-blue-600 rounded-xl p-4 shadow-lg text-white">
        ...
        <div className="mt-3 text-xs bg-blue-700/30 p-2 rounded border border-blue-400/30 flex gap-2">
           <AlertCircle size={14} className="flex-shrink-0 mt-0.5" />
           <span>Critérios de desempate utilizados: 1. Pontos, 2. Confronto Direto, 3. Saldo de Gols, 4. Gols Pró.</span>
        </div>
      </div>
