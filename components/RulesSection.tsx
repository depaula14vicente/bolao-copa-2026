...
import { AlertCircle, Award, CheckCircle2, FileText, Info, ChevronDown, ChevronUp, Scale, BookOpen } from 'lucide-react';
...
export const RulesSection: React.FC<RulesSectionProps> = ({ scoringRules, ticketPrice, prizeDistribution, specialTeams = [], specialPhases = [] }) => {
  return (
    <div className="space-y-4 animate-fade-in pb-10">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-6 text-white shadow-lg relative overflow-hidden mb-6">
            <div className="absolute top-0 right-0 p-4 opacity-10">
                <BookOpen size={120} className="text-white" />
            </div>
            <h2 className="text-2xl font-black flex items-center gap-2 relative z-10">
                <BookOpen className="text-purple-200" /> Regulamento
            </h2>
            <p className="text-purple-50 text-sm mt-1 opacity-90 relative z-10">
                Entenda como funciona o sistema de pontos, premiação e critérios de desempate.
            </p>
        </div>
