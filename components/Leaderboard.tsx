      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-4">
         ...
         <div className="flex bg-gray-100 dark:bg-slate-800 p-1 rounded-xl">
             <button 
                ...
                className={`px-4 py-2 rounded-lg text-sm font-bold transition-all flex items-center gap-2 ${activeTab === 'RANKING' ? 'bg-white dark:bg-slate-700 text-slate-800 dark:text-white shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200'}`}
             >
                <LayoutList size={16} /> Geral
             </button>
             <button 
                onClick={() => setActiveTab('STATS')}
                className={`px-4 py-2 rounded-lg text-sm font-bold transition-all flex items-center gap-2 ${activeTab === 'STATS' ? 'bg-white dark:bg-slate-700 text-slate-800 dark:text-white shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200'}`}
             >
      ...
      <>
        <div className="flex flex-col md:flex-row justify-between items-end gap-4 mb-4">
             ...
             <button
                ...
                className={`flex items-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white px-4 py-3 rounded-lg font-bold shadow-md transition-transform active:scale-95 text-sm h-full ${isGenerating ? 'opacity-70 cursor-wait' : ''}`}
            >
