...
export const UserProfile: React.FC<UserProfileProps> = ({ user, onUpdateUser, ticketPrice }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-20">
       ...
       <div className="bg-gradient-to-r from-pink-600 to-rose-600 rounded-xl p-6 text-white shadow-lg relative overflow-hidden mb-6">
            <div className="absolute top-0 right-0 p-4 opacity-10">
                <UserIcon size={120} className="text-white" />
            </div>
            <h2 className="text-2xl font-black flex items-center gap-2 relative z-10">
                <UserIcon className="text-pink-200" /> Meu Perfil
            </h2>
            <p className="text-pink-50 text-sm mt-1 opacity-90 relative z-10">
                Gerencie seus dados pessoais, senha e personalize seu avatar.
            </p>
       </div>
